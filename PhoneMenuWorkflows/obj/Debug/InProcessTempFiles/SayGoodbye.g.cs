...
namespace PhoneMenuWorkflows {
    ...
    public partial class SayGoodbye : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<string> _GoodbyeStatement;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<string> GoodbyeStatement {
            get {
                return this._GoodbyeStatement;
            }
            set {
                this._GoodbyeStatement = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SayGoodbye).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SayGoodbye));
        ...
        private string FindResource() {
            string[] resources = typeof(SayGoodbye).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SayGoodbye.g.xaml") || resource.Equals("SayGoodbye.g.xaml"))) {
                    return resource;
                }
            }
